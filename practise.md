...
阅读开源软件代码，可以提到。之前 。在之前的那篇『如何以“正确的姿势”阅读开源软件代码』中，我建议的阅读开源软件代码的方式是：
...
可只读这些代码，不能让我们提高，我们应该结合重构这个技能来练习。

依我的练习经验看来，对于重构的练习是最有意思的。因为 GitHub 上有大量的开源代码，我们可以：

 - 找一个不错的开源库
 - 阅读其中的代码
 - 对**自己认为设计**得不好的代码重构

需要注意的是，不同的人对于代码设计，有着不同的观点。因此，
