...
我的“自我解释”是：**今天的编程语言设计得不合理**——使用了各种字符，导致了右手在这方面的负担比较大。

在那之后，我便陆续进行了一些基础的练习，并整理他们的因果关系，便有了下面的一些练习项目：
...
虽说，编码只是一个打字的过程，但是很多时候，经常出现的错字会中断我们的思路。因此，**盲打应该做程序员的基本技能**。而这里的盲打，指的并不是你可以闭上眼晴可以打字聊天，而可以完成编程工作，即能盲打下 26 个字母，及各种字符，还有各种功能键。
...
当时，我拿 Typing 练习的时候，差不多练习了一个月，每天大概半小时左右。因为打字的速度比较快，所以容易出错，所以便将注意力放在减少错误上。而对于有些人来说，则是相反的，即打字速度比较慢，但是准确率比较高。而这个练习的主要目的是，能熟练地做到**盲打**，不让它影响你的效率。

### 基础练习：掌握开发工具

掌握了熟练开关机、键盘上的各种按键后，我们就在使用工具上做一些提升。对于开发工具而言，我们没有必要掌握所有的快捷键，而是那些常用的功能。我常用的开发工具有，对应的我只掌握了一些基本的、常用的快捷键：

当我在现在的公司实习的时候，我发现每个有经验的程序员，几乎都不用鼠标。他们可以熟练的使用各种快捷键，进行代码重构、打开新页面、开启新窗口等等的操作。而作为一个使用 Java 语言与 Intellij Idea 写后台的程序员，我觉得我应该也要能达到这样的水平。Intellij Idea 的快捷键相当的多，在日常结对编程的时候，向

大部分的开发工具，都有对应的 cheatsheet，即“作弊表”。如下是 Intellij Idea 的 Cheatsheet

上面列出了可用的快捷键，使用这些 cheatsheet，我们可以轻松地。他们有不同的形式，如鼠标垫、杯子。

而当时我陷入了一个误区，我在学习的时候，边练习一些重构的技巧，也因此花费了多余的时候在练习一些『屠龙之术』。SHIFT+F6 重命名、Command+E 切换最近文件、SHIFT+Alt+Command 重构。

时间一久，我便忘了很多的快捷键。

如 Vim，对于我而言，一般用于服务器维护及 Git 修改。因此，主要使用的功能便是：快速地改几个字符、更新配置，保存并退出。

又如 Chrome 浏览器，在日常使用时，配合下 Vim 插件，便不需要鼠标。在进行前端开发的时候，便需要高度鼠标来调试。

对于大部分的工具来说，你只需要一个 CheatSheet。复杂的工具，如 Vim、Emacs，则需要有一本更专业的书。

而，要衡量这方面的提升，还缺乏一个比较有效的工具。如果有的话，那么就是你在编码时，使用鼠标的频率。

因此，在某些特定的时候，可以通过禁用鼠标来提升自己在这方面的能力~。
